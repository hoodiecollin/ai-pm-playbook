<!--
  Hand-maintained router. Copied verbatim to assets/playbook/AGENT.md at build time, after
  scripts/split-assets.ts verifies that every reference/*.md named here exists and that every
  generated file is named here. A mismatch fails the build.
-->
